...
public class DepartmentsTest {
    ...
    public void sortAscTest() {
        List<String> input = Arrays.asList("K2", "K2/SK1", "K1", "K2/SK1/SSK1", "K2/SK1/SSK2", "K1/SK1", "K1/SK1/SSK1", "K1/SK1/SSK2", "K1/SK2");
    ...
    public void sortDescTest() {
        List<String> input = Arrays.asList("K2", "K2/SK1", "K1", "K2/SK1/SSK1",  "K1/SK1", "K1/SK1/SSK1", "K2/SK1/SSK2", "K1/SK1/SSK2", "K1/SK2");
