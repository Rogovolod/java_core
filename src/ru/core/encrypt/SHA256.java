...
/**
* There are two variants about encrypt SHA-256
**/
...
public class SHA256 {
     ...
     * also we can use another encrypt right there
     **/
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        /**
         * The second way use function bytesToHex(byte[] hash)
         * recommended by
